...
export function buildSaveConflictModalView({
  ...
  return {
    ...
    contextLines,
    actions: {
      refreshLabel: "Загрузить версию с сервера",
      refreshHint: "Серверная версия станет текущей; несохранённые локальные правки будут заменены.",
      overwriteLabel: "Оставить мою версию",
      overwriteHint: "Сохранить вашу версию поверх серверной (база = текущая серверная версия); действие фиксируется в истории.",
      reportLabel: "Сообщить об ошибке",
      reportHint: "Отправить технический отчёт с последними действиями — поможет найти причину конфликта.",
    },
  };
}
