...
const OPS_STAGE_VIEW = Object.freeze({
  ...
  // S6 (degrade-замена, PLAN §7): честные остановки вместо silent full-PUT.
  "ops-conflict": { state: "failed", label: "Конфликт версий", title: "Автоматическое разрешение не сошлось. Откройте диалог конфликта: правки не потеряны и ожидают действия." },
  "ops-unsupported": { state: "failed", label: "Изменение не поддержано дельта-сохранением", title: "Сервер отклонил операцию (причина в деталях). Правки сохранены локально; отмените изменение или сохраните вручную." },
  "ops-error": { state: "failed", label: "Не удалось сохранить изменения", title: "Сеть или сервер недоступны. Правки не потеряны и будут повторены автоматически." },
});
