...
// (кнопка show/hide) без prop-drilling. Состояние не персистится (UI.md);
// видимость подложки сбрасывается при выходе из режима (смена сессии/флаг).
// Поведение зеркалирует mockOverlayModeStore (аудит Q5): глобально, без persist.
