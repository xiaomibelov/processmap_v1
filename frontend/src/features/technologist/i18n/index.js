// L10N — механизм локализации UI технолога (L2).
// Строки живут в файлах-словарях (ru.js, en.js); компоненты берут их через t().
// Язык по умолчанию — ru. Смена языка = смена файла словаря (setLocale),
