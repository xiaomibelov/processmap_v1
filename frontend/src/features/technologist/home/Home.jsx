...
export default function TechnologistHome() {
  ...
  function hrefForStep(tpl, stepId) {
    ...
    switch (stepId) {
      case "import": return "/technologist/import-bpmn";
      case "transform": return "/technologist/transform";
      case "constructor": return `/technologist/constructor?template=${id}`;
      case "recipe": return `/technologist/recipes?template=${id}`;
      case "check": return `/technologist/constructor?template=${id}&check=1`;
  ...
  return (
    <div className="tech-home">
      ...
      <div className="tech-home__head">
        ...
        <a className="tech-home__new" data-testid="home-new-process" href="/technologist/import-bpmn">
          {t("wf.home.new")}
        </a>
      </div>
      ...
      {!loading && templates.length === 0 ? (
        <div className="tech-home__empty" data-testid="home-empty">
          <p>{t("wf.home.empty")}</p>
          <a className="tech-home__new" href="/technologist/import-bpmn">{t("wf.home.new")}</a>
        </div>
      ) : null}
