        ...
        <table className="w-full min-w-[1280px] border-collapse text-sm">
          <thead className="text-left text-[11px] uppercase tracking-[0.16em] text-slate-400">
            <tr>
              ...
              <th className="px-3 py-3">Git mirror</th>
              ...
              return (
                <tr key={toText(row?.session_id)} className="border-t border-slate-100 align-top">
                  ...
                  <td className="px-3 py-3">
                    <StatusPill status={mirrorMeta.label} tone={mirrorMeta.adminTone} />
                    {mirrorSnapshot.versionNumber > 0 ? (
                      <div className="mt-1 text-[11px] text-slate-500">v{String(mirrorSnapshot.versionNumber)}</div>
                    ) : null}
                  </td>
