...
export default function AnalyticsHub({
  ...
  return (
    <main className="analyticsHubPage" data-testid="analytics-hub-page">
      <section className="analyticsHubSurface">
        ...
        <div className="analyticsHubModules" aria-label="Модули аналитики">
          {MODULES.map((module) => {
            const handler = module.id === "registry"
              ...
              : module.id === "properties"
                ...
                : null;
            return (
              <article className="analyticsHubModule" data-testid={module.testId} key={module.id}>
                <div>
                  <h2>{module.title}</h2>
                ...
                {handler ? (
                  ...
                  <span className="analyticsHubPlaceholder">{module.action}</span>
                )}
              </article>
            );
          })}
