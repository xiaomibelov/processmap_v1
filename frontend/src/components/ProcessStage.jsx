...
export default function ProcessStage({
  ...
  const topPanelsView = useMemo(
    ...
    [
      ...
      setQualityProfileId,
      setTemplatesEnabled,
      stageActions.closeToolbarMenu,
      stageActions.openQualityAutoFix,
      suggestedTemplates,
      templatesEnabled,
      toNodeId,
      toolbarMenuOpen,
  ...
  const attentionPanelsView = useMemo(
    () => ({
      tab,
      hasSession,
      attentionOpen,
  ...
  const dialogsView = useMemo(
    ...
    [
      ...
      shortSnapshotHash,
      snapshotLabel,
      stageActions.closeCreateTemplateDialog,
      stageActions.closeDiffDialog,
      stageActions.closeInsertBetweenDialog,
      stageActions.closeQualityAutoFix,
      stageActions.closeTemplatesPickerDialog,
      stageActions.closeVersionsDialog,
      stageActions.openDiffDialog,
      templateCounts,
      templatesBusy,
      templatesPickerOpen,
      templatesScope,
