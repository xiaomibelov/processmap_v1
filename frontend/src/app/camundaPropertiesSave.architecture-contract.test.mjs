...
test("setElementCamundaExtensions is routed to unified saveBpmnState pipeline (no primary PATCH /sessions path)", () => {
  ...
  assert.match(block, /saveBpmnState\(/);
  assert.doesNotMatch(block, /persistCamundaExtensionsViaCanonicalXmlBoundary\(/);
