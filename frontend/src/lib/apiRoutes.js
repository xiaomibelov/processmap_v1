...
export const apiRoutes = {
  ...
  admin: {
    ...
    llmProviders: () => "/api/admin/llm/providers",
    llmProvider: (id) => `/api/admin/llm/providers/${encode(id)}`,
    llmProviderTest: (id) => `/api/admin/llm/providers/${encode(id)}/test`,
    llmModules: () => "/api/admin/llm/modules",
    llmExecutions: (params = {}) => withQuery("/api/admin/llm/executions", params),
    llmPrompts: (params = {}) => withQuery("/api/admin/llm/prompts", params),
    llmPrompt: (id) => `/api/admin/llm/prompts/${encode(id)}`,
    llmPromptActivate: (id) => `/api/admin/llm/prompts/${encode(id)}/activate`,
    llmPromptRollback: (id) => `/api/admin/llm/prompts/${encode(id)}/rollback`,
    llmFeatures: () => "/api/admin/llm/features",
    llmFeature: (feature) => `/api/admin/llm/features/${encode(feature)}`,
    llmUsage: (params = {}) => withQuery("/api/admin/llm/usage", params),
    testgenRun: () => "/api/admin/testgen/run",
    testgenRuns: (params = {}) => withQuery("/api/admin/testgen/runs", params),
    testgenRunDetail: (runId) => `/api/admin/testgen/runs/${encode(runId)}`,
    llmModels: () => "/api/admin/llm/models",
    llmModel: (id) => `/api/admin/llm/models/${encode(id)}`,
    llmModelSetDefault: (id) => `/api/admin/llm/models/${encode(id)}/set-default`,
    llmFeatureModels: () => "/api/admin/llm/feature-models",
  ...
  analytics: {
    ...
    exportAdvancedCalculationXlsx: (scope, scopeId) => withQuery("/api/analytics/export-advanced-calculation.xlsx", {
      scope: String(scope || "").trim(),
      scope_id: String(scopeId || "").trim(),
    }),
