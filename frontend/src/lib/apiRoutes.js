...
export const apiRoutes = {
  ...
  admin: {
    ...
    sessionAnalyticsSummary: (params = {}) => withQuery("/api/admin/analytics/sessions/summary", params),
    sessionAnalyticsTop: (params = {}) => withQuery("/api/admin/analytics/sessions/top", params),
    sessionAnalyticsCaseStudies: (params = {}) => withQuery("/api/admin/analytics/sessions/case-studies", params),
