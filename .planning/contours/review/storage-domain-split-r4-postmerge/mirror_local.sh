...
# Local mirror for review/storage-domain-split-r4-postmerge artifacts into the server-backup Obsidian mirror.
...
CID="review/storage-domain-split-r4-postmerge"
