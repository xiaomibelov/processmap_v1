...
- **area/query**: executor part 1 context
- **generated_at**: 2026-05-16T22:58:49.251Z
...
**Contour:** `feature/processmap-agent-rag-coverage-and-validation-hardening-v1` **Run_id:** `20260516T151430Z-2767` **Agent:** Agent 2 / *Executor* ---
```
...
- ```bash
node tools/rag/pm-rag-search.mjs "executor part 1 context" --top-k 5
```
- ```bash
node tools/rag/pm-rag-search-facts.mjs "executor part 1 context" --top-k 8 --json
```
- ```bash
node tools/rag/pm-rag-agent-preflight.mjs --role executor --contour "fix/diagram-interaction-mode-visual-regression-v1" --area "executor part 1 context" --format md
```
- ```bash
