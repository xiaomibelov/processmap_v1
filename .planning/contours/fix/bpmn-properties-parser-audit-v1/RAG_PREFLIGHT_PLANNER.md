...
- generated_at: `2026-05-27T19:46:02Z`
- command: `node tools/rag/pm-rag-agent-preflight.mjs --role planner --contour "fix/bpmn-properties-parser-audit-v1" --area "ProcessMap planning context fix/bpmn-properties-parser-audit-v1" --format md --top-k 5`
...
- **role**: planner
- **contour**: fix/bpmn-properties-parser-audit-v1
- **area/query**: ProcessMap planning context fix/bpmn-properties-parser-audit-v1
- **generated_at**: 2026-05-27T19:45:57.685Z
...
- ```bash
node tools/rag/pm-rag-search.mjs "ProcessMap planning context fix/bpmn-properties-parser-audit-v1" --top-k 5
```
- ```bash
node tools/rag/pm-rag-search-facts.mjs "ProcessMap planning context fix/bpmn-properties-parser-audit-v1" --top-k 8 --json
```
- ```bash
node tools/rag/pm-rag-agent-preflight.mjs --role planner --contour "fix/bpmn-properties-parser-audit-v1" --area "ProcessMap planning context fix/bpmn-properties-parser-audit-v1" --format md
```
- ```bash
