...
## Input
- **role**: executor
- **contour**: fix/tobe-element-provenance-persistence-v1
- **area/query**: 
- **generated_at**: 2026-09-16T09:38:19.599Z
...
- ```bash
node tools/rag/pm-rag-search.mjs "fix/tobe-element-provenance-persistence-v1" --top-k 5
```
- ```bash
node tools/rag/pm-rag-search-facts.mjs "fix/tobe-element-provenance-persistence-v1" --top-k 8 --json
```
- ```bash
node tools/rag/pm-rag-agent-preflight.mjs --role executor --contour "fix/tobe-element-provenance-persistence-v1" --area "scope" --format md
```
- ```bash
