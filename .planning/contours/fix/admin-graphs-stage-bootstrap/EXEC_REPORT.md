...
- PR #870 смержена в `main` (`42779eca82b7ced6793c7a6ff3af1b74d1c5b47a`).
- Статус контура: `MERGED_WAITING_FOR_DEPLOY`.
- Следующий шаг: deploy на stage + создание первого снапшота + верификация.
