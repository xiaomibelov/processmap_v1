...
- generated_at: `2026-05-21T20:12:47Z`
- command: `node tools/rag/pm-rag-agent-preflight.mjs --role planner --contour "test-plan-2026-05-21" --area "ProcessMap planning context test-plan-2026-05-21" --format md --top-k 5`
...
- **role**: planner
- **contour**: test-plan-2026-05-21
- **area/query**: ProcessMap planning context test-plan-2026-05-21
- **generated_at**: 2026-05-21T20:12:42.113Z
...
- **score**: 37.825 - **path**: `/opt/*processmap*-*test*/.**plan*ning*/contours/release/*processmap*-consolidate-dirty-tree-fix-*test*s-and-stage-v1/OBSIDIAN_*CONTEXT*_USED.md` - **source/category**: **plan*ning*-contours / contour - **why_matched**: exact_contour_id, path_match, heading_match, recent_14d, category_role - **snippet**: ``` [contour: **processmap**-consolidate-dirty-tree-*fix*-*test*s-and-*stage*-*v1*] ## Obsidian **Context** Used - run_id: `*2026**05**21*T090400Z-76203` - contour: `*release*/**processmap**…
```
...
- ```bash
node tools/rag/pm-rag-search.mjs "ProcessMap planning context test-plan-2026-05-21" --top-k 5
```
- ```bash
node tools/rag/pm-rag-search-facts.mjs "ProcessMap planning context test-plan-2026-05-21" --top-k 8 --json
```
- ```bash
node tools/rag/pm-rag-agent-preflight.mjs --role planner --contour "test-plan-2026-05-21" --area "ProcessMap planning context test-plan-2026-05-21" --format md
```
- ```bash
