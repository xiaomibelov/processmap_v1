...
- generated_at: `2026-05-23T14:39:25Z`
...
- **generated_at**: 2026-05-23T14:39:20.724Z
...
- **snippet**:
```
[*contour*: *processmap*-consolidate-dirty-tree-fix-tests-and-stage-*v1*] ## 5. *Contour* Reports
**Score:** 31.061 | **Matched:** obsidian, project, atlas, *processmap*, *planning*, *v1* **Boosts:** exact_*contour*_id, path_match, recent_14d, category_role **Why matched:** exact_*contour*_id, path_match, recent_14d, category_role ``` [*contour*: **processmap**-agents-launcher-logic-and-dependencies-*audit*-**v1**] - `/opt/**processmap**-test/.**planning**/*contour*s/tooling/**processmap**-agents-launcher-logic-and-dependencies-*audit*-**v1**/` - `/srv/*obsidian*/*project*-*atlas*/**ProcessMap**/AgentReports/tooling/**processmap**-age…
```
