...
- generated_at: `2026-05-22T20:54:17Z`
- command: `node tools/rag/pm-rag-agent-preflight.mjs --role planner --contour "cleanup/analytics-single-source-of-truth-v1" --area "ProcessMap planning context cleanup/analytics-single-source-of-truth-v1" --format md --top-k 5`
...
- **role**: planner
- **contour**: cleanup/analytics-single-source-of-truth-v1
- **area/query**: ProcessMap planning context cleanup/analytics-single-source-of-truth-v1
- **generated_at**: 2026-05-22T20:54:12.318Z
...
### #1 — Obsidian Context
- **score**: 35.042
- **path**: `/opt/processmap-test/.planning/contours/ui/analytics-workspace-cleanup-and-registry-redesign-v1/CONTEXT_USED_REVIEWER.md`
- **source/category**: planning-contours / contour
- **why_matched**: exact_contour_id, path_match, heading_match, recent_14d, category_role
- **snippet**:
```
[contour: *analytics*-workspace-*cleanup*-and-registry-redesign-*v1*] ## Obsidian *Context*
- Obsidian root: `/srv/obsidian/project-atlas/*ProcessMap*` - Relevant indexed files: `AgentReports/ui/*analytics*-workspace-*cleanup*-and-registry-redesign-*v1*/INDEX.md` - No specific *planning* decisions changed during review; runtime verification was primary *source* of *truth*.
```

### #2 — 4. Obsidian Context
- **score**: 34.851
- **path**: `/opt/processmap-test/.planning/contours/ui/analytics-inter-registry-navigation-v1/planner-stale-superseded-20260522T152523Z-63480-20260522T152551Z/OBSIDIAN_CONTEXT_USED.md`
- **source/category**: planning-contours / contour
- **why_matched**: exact_contour_id, path_match, heading_match, recent_14d, category_role
- **snippet**:
```
[contour: *analytics*-inter-registry-navigation-*v1*] ## 4. Obsidian *Context*
**Score:** 44.837 | **Matched:** obsidian, project, atlas, *processmap*, *planning*, *context*, ui, *analytics*, registry, *v1* **Boosts:** exact_contour_id, path_match, heading_match, recent_14d, category_role **Why matched:** exact_contour_id, path_match, heading_match, recent_14d, category_role ``` [contour: **analytics**-workspace-*cleanup*-and-*registry*-redesign-**v1**] ## *Obsidian* **Context** - *Obsidian* root: `/srv/*obsidian*/*project*-*atlas*/**ProcessMap**` - Relevant indexed files: `AgentReports/*ui*/**analytics**-workspace-clean…
```

### #3 — Search Results
- **score**: 33.299
- **path**: `/opt/processmap-test/.planning/contours/ui/analytics-workspace-cleanup-and-registry-redesign-v1/OBSIDIAN_CONTEXT_USED.md`
- **source/category**: planning-contours / contour
- **why_matched**: exact_contour_id, path_match, recent_14d, category_role
- **snippet**:
```
[contour: *analytics*-workspace-*cleanup*-and-registry-redesign-*v1*] **Query:** Obsidian Project Atlas *ProcessMap* *planning* *context* ui/*analytics*-workspace-*cleanup*-and-registry-redesign-*v1* **Terms:** obsidian, project, atlas, *processmap*, *planning*, *context*, ui, *analytics*, workspace, *cleanup*, registry, redesign, *v1* **Results:** 5 | Rank | Score | Path | Title | Category | Class | Verdict | |------|-------|------|-------|----------|-------|---------| | 1 | 54.885 | `/srv/obsidian/project-atlas/*ProcessMap*/AgentReports/ui/*analytics*-workspace-*cleanup*-and-registry-redesign-*v1*/INDEX.md` | Mirror | project_at…
```
...
- ```bash
node tools/rag/pm-rag-search.mjs "ProcessMap planning context cleanup/analytics-single-source-of-truth-v1" --top-k 5
```
- ```bash
node tools/rag/pm-rag-search-facts.mjs "ProcessMap planning context cleanup/analytics-single-source-of-truth-v1" --top-k 8 --json
```
- ```bash
node tools/rag/pm-rag-agent-preflight.mjs --role planner --contour "cleanup/analytics-single-source-of-truth-v1" --area "ProcessMap planning context cleanup/analytics-single-source-of-truth-v1" --format md
```
- ```bash
