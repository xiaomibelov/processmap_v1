...
- generated_at: `2026-05-22T08:47:32Z`
- command: `node tools/rag/pm-rag-agent-preflight.mjs --role planner --contour "workflow/pr-stage-manual-merge-only-v1" --area "ProcessMap planning context workflow/pr-stage-manual-merge-only-v1" --format md --top-k 5`
...
- **role**: planner
- **contour**: workflow/pr-stage-manual-merge-only-v1
- **area/query**: ProcessMap planning context workflow/pr-stage-manual-merge-only-v1
- **generated_at**: 2026-05-22T08:47:27.512Z
...
- **snippet**:
```
[contour: **pr*ocessmap*-*v1*-0-140-*stage*-*pr*omotion-and-analytics-entry-fix-*v1*] ## 6. *Context* Sources
- RAG *pr*eflight: `.*planning*/contours/release/**pr*ocessmap*-*v1*-0-140-*stage*-*pr*omotion-and-analytics-entry-fix-*v1*/RAG_*PR*EFLIGHT_PLANNER.md` - Obsidian *context*: `.*planning*/contours/release/**pr*ocessmap*-*v1*-0-140-*stage*-*pr*omotion-and-analytics-entry-fix-*v1*/OBSIDIAN_*CONTEXT*_USED.md` - GSD *context*: `.*planning*/contours/release/**pr*ocessmap*-*v1*-0-140-*stage*-*pr*omotion-and-analytics-entry-fix-*v1*/GSD_*CONTEXT*_USED.md` - *Pr*evious contour: `.*planning*/contours/release/**pr*ocessmap*-consolidate-dirty-tree-fix-tests-and-*stage*-*v1*/P…
```
...
```
[contour: **pr*ocessmap*-*v1*-0-140-*stage*-*pr*omotion-and-analytics-entry-fix-*v1*] ## 6. **Context** Sources
- RAG *pr*eflight: `.**planning**/contours/*release*/***pr*ocessmap**-**v1**-0-*140*-**stage**-**pr*omotion*-and-*analytics*-*entry*-*fix*-**v1**/RAG_*PR*EFLIGHT_PLANNER.md` - Obsidian **context**: `.**planning**/contours/*release*/***pr*ocessmap**-**v1**-0-*140*-**stage**-**pr*omotion*-and-*analytics*-*entry*-*fix*-**v1**/OBSIDIAN_**CONTEXT**_USED.md` - GSD **context**: `.**planning**/contours/*release*/***pr*ocessmap**-**v1**-0-*140*-**stage**-**pr*omotion*-and-*analytics*-*entry*-*fix*-**v1**/GSD_**CONTEXT**_USED.md` - *Pr*evious contour: `.*plannin…
```
...
- ```bash
node tools/rag/pm-rag-search.mjs "ProcessMap planning context workflow/pr-stage-manual-merge-only-v1" --top-k 5
```
- ```bash
node tools/rag/pm-rag-search-facts.mjs "ProcessMap planning context workflow/pr-stage-manual-merge-only-v1" --top-k 8 --json
```
- ```bash
node tools/rag/pm-rag-agent-preflight.mjs --role planner --contour "workflow/pr-stage-manual-merge-only-v1" --area "ProcessMap planning context workflow/pr-stage-manual-merge-only-v1" --format md
```
- ```bash
