# Reviewer Prompt: stage8/test-devserver-1781309535
...
Write `REVIEW_REPORT.md` in `.planning/contours/stage8/test-devserver-1781309535/`.

If acceptable:

```bash
touch .planning/contours/stage8/test-devserver-1781309535/REVIEW_PASS
```

If changes are required:

```bash
touch .planning/contours/stage8/test-devserver-1781309535/CHANGES_REQUESTED
```

Never create both markers.

Post: `./tools/pm-agent-mirror-report.sh "stage8/test-devserver-1781309535" reviewer`
