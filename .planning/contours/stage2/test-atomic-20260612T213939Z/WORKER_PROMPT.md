# Agent 2 (Worker) — Contour: stage2/test-atomic-20260612T213939Z
...
## Environment
- Contour directory: `.planning/contours/stage2/test-atomic-20260612T213939Z/`
...
```bash
cd /opt/processmap-test/.planning/contours/stage2/test-atomic-20260612T213939Z
...
- Any new untracked files are confined to `.planning/contours/stage2/test-atomic-20260612T213939Z/`.
...
### 6. Create marker
```bash
touch /opt/processmap-test/.planning/contours/stage2/test-atomic-20260612T213939Z/WORKER_DONE
```
