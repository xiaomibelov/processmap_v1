# Contour: stage2/test-atomic-20260612T213939Z
...
## 2. Bounded Scope
- **In scope:**
  - Atomic file creation discipline inside `.planning/contours/stage2/test-atomic-20260612T213939Z/`.
  - Git-state verification: no changes to tracked product files, no untracked files outside the contour directory.
...
- Base truth: `origin/main` (`01e1cb4537579cb225274c0eedf81978305a1868`)
- Status: dirty (unrelated untracked files present); no staged changes.

## 4. Acceptance Criteria
| # | Criterion | Verification |
|---|-----------|--------------|
| 1 | Source truth recorded | `git branch --show-current`, `git rev-parse HEAD`, `git status -sb` captured in `WORKER_REPORT.md` |
...
| 5 | Scope containment | New untracked files are limited to `.planning/contours/stage2/test-atomic-20260612T213939Z/` |
...
## 10. Handoff Marker
Agent 2 waits for: `READY_FOR_EXECUTION` directory marker present in `.planning/contours/stage2/test-atomic-20260612T213939Z/`.
