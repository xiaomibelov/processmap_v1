...
| 5 | Scope containment | New untracked files are limited to `.planning/contours/stage2/test-atomic-20260612T214218Z/` |
...
## 10. Handoff Marker
Agent 2 waits for: `READY_FOR_EXECUTION` directory marker present in `.planning/contours/stage2/test-atomic-20260612T214218Z/`.
