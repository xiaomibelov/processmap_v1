# Agent 2 (Worker) — Contour: stage2/test-atomic-20260612T214218Z
...
## Environment
- Contour directory: `.planning/contours/stage2/test-atomic-20260612T214218Z/`
...
- Any new untracked files are confined to `.planning/contours/stage2/test-atomic-20260612T214218Z/`.
...
### 6. Create marker
```bash
touch /opt/processmap-test/.planning/contours/stage2/test-atomic-20260612T214218Z/WORKER_DONE
```
