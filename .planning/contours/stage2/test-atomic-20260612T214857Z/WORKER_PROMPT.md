# Agent 2 (Worker) — Contour: stage2/test-atomic-20260612T214857Z
...
## Environment
- Contour directory: `.planning/contours/stage2/test-atomic-20260612T214857Z/`
...
```bash
cd /opt/processmap-test/.planning/contours/stage2/test-atomic-20260612T214857Z
...
- Any new untracked files are confined to `.planning/contours/stage2/test-atomic-20260612T214857Z/`.
...
### 6. Create marker
```bash
touch /opt/processmap-test/.planning/contours/stage2/test-atomic-20260612T214857Z/WORKER_DONE
```
