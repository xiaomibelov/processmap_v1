# Contour: stage2/test-atomic-20260612T214857Z
...
## 2. Bounded Scope
- **In scope:**
  - Atomic file creation discipline inside `.planning/contours/stage2/test-atomic-20260612T214857Z/`.
...
| 5 | Scope containment | New untracked files are limited to `.planning/contours/stage2/test-atomic-20260612T214857Z/` |
...
## 10. Handoff Marker
Agent 2 waits for: `READY_FOR_EXECUTION` directory marker present in `.planning/contours/stage2/test-atomic-20260612T214857Z/`.
