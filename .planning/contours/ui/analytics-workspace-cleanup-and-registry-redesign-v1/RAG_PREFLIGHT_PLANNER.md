...
- generated_at: `2026-05-22T12:27:19Z`
- command: `node tools/rag/pm-rag-agent-preflight.mjs --role planner --contour "ui/analytics-workspace-cleanup-and-registry-redesign-v1" --area "ProcessMap planning context ui/analytics-workspace-cleanup-and-registry-redesign-v1" --format md --top-k 5`
...
- **role**: planner
- **contour**: ui/analytics-workspace-cleanup-and-registry-redesign-v1
- **area/query**: ProcessMap planning context ui/analytics-workspace-cleanup-and-registry-redesign-v1
- **generated_at**: 2026-05-22T12:27:13.585Z
...
### #1 — RAG Preflight Planner
- **score**: 47.813
- **path**: `/opt/processmap-test/.planning/contours/ui/analytics-workspace-cleanup-and-registry-redesign-v1/RAG_PREFLIGHT_PLANNER.md`
- **source/category**: planning-contours / contour
- **why_matched**: exact_contour_id, path_match, recent_14d, category_role
- **snippet**:
```
[contour: *analytics*-*workspace*-*cleanup*-and-*registry*-*redesign*-*v1*] - run_id: `20260522T121703Z-96444` - contour: `*ui*/*analytics*-*workspace*-*cleanup*-and-*registry*-*redesign*-*v1*` - generated_by: `*processmap*-agent-pane.sh` - generated_at: `2026-05-22T12:17:28Z` - refreshed_by: `Agent 1 / Planner` - refreshed_at: `2026-05-22T12:20:00Z` - command: `node tools/rag/pm-rag-agent-preflight.mjs --role planner --contour "*ui*/*analytics*-*workspace*-*cleanup*-and-*registry*-*redesign*-*v1*" --area "*ProcessMap* *planning* *context* *ui*/*analytics*-*workspace*-*cleanup*-and-*registry*-*redesign*-*v1*" --format md --top-k 5`
```

### #2 — RAG Preflight Planner
- **score**: 45.313
- **path**: `/srv/obsidian/project-atlas/ProcessMap/AgentReports/ui/analytics-workspace-cleanup-and-registry-redesign-v1/RAG_PREFLIGHT_PLANNER.md`
...
### #3 — Source
- **score**: 44.888
- **path**: `/srv/obsidian/project-atlas/ProcessMap/AgentReports/ui/analytics-workspace-cleanup-and-registry-redesign-v1/INDEX.md`
- **source/category**: project-atlas / project_atlas
- **why_matched**: path_match, recent_14d, category_role
- **snippet**:
```
```text /opt/*processmap*-test/.*planning*/contours/*ui*/*analytics*-*workspace*-*cleanup*-and-*registry*-*redesign*-*v1* ```
```
...
- ```bash
node tools/rag/pm-rag-search.mjs "ProcessMap planning context ui/analytics-workspace-cleanup-and-registry-redesign-v1" --top-k 5
```
- ```bash
node tools/rag/pm-rag-search-facts.mjs "ProcessMap planning context ui/analytics-workspace-cleanup-and-registry-redesign-v1" --top-k 8 --json
```
- ```bash
node tools/rag/pm-rag-agent-preflight.mjs --role planner --contour "ui/analytics-workspace-cleanup-and-registry-redesign-v1" --area "ProcessMap planning context ui/analytics-workspace-cleanup-and-registry-redesign-v1" --format md
```
- ```bash
