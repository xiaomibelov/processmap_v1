...
- generated_at: `2026-05-22T15:25:57Z`
...
- **generated_at**: 2026-05-22T15:25:51.974Z
...
### #1 — Input
- **score**: 50.941
- **path**: `/opt/processmap-test/.planning/contours/ui/analytics-inter-registry-navigation-v1/RAG_PREFLIGHT_PLANNER.md`
...
- **snippet**:
```
[contour: *analytics*-*inter*-*registry*-*navigation*-*v1*] - ```bash node tools/rag/pm-rag-search.mjs "*ProcessMap* *planning* *context* *ui*/*analytics*-*inter*-*registry*-*navigation*-*v1*" --top-k 5 ``` - ```bash node tools/rag/pm-rag-search-facts.mjs "*ProcessMap* *planning* *context* *ui*/*analytics*-*inter*-*registry*-*navigation*-*v1*" --top-k 8 --json ``` - ```bash node tools/rag/pm-rag-agent-preflight.mjs --role planner --contour "*ui*/*analytics*-*inter*-*registry*-*navigation*-*v1*" --area "*ProcessMap* *planning* *context* *ui*/*analytics*-*inter*-*registry*-*navigation*-*v1*" --format md ``` - ```bash node tools/rag/pm-rag-validate-facts.mjs ``` - ```bas…
```

### #3 — Input
- **score**: 48.441
- **path**: `/srv/obsidian/project-atlas/ProcessMap/AgentReports/ui/analytics-inter-registry-navigation-v1/RAG_PREFLIGHT_PLANNER.md`
- **source/category**: project-atlas / project_atlas
- **why_matched**: path_match, recent_14d, category_role
- **snippet**:
```
- **role**: planner - **contour**: *ui*/*analytics*-*inter*-*registry*-*navigation*-*v1* - **area/query**: *ProcessMap* *planning* *context* *ui*/*analytics*-*inter*-*registry*-*navigation*-*v1* - **generated_at**: 2026-05-22T14:32:42.814Z
```
