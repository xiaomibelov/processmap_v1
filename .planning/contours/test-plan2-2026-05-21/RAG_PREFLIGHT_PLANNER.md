...
- generated_at: `2026-05-21T20:14:09Z`
- command: `node tools/rag/pm-rag-agent-preflight.mjs --role planner --contour "test-plan2-2026-05-21" --area "ProcessMap planning context test-plan2-2026-05-21" --format md --top-k 5`
...
- **role**: planner
- **contour**: test-plan2-2026-05-21
- **area/query**: ProcessMap planning context test-plan2-2026-05-21
- **generated_at**: 2026-05-21T20:14:04.185Z
...
- ```bash
node tools/rag/pm-rag-search.mjs "ProcessMap planning context test-plan2-2026-05-21" --top-k 5
```
- ```bash
node tools/rag/pm-rag-search-facts.mjs "ProcessMap planning context test-plan2-2026-05-21" --top-k 8 --json
```
- ```bash
node tools/rag/pm-rag-agent-preflight.mjs --role planner --contour "test-plan2-2026-05-21" --area "ProcessMap planning context test-plan2-2026-05-21" --format md
```
- ```bash
