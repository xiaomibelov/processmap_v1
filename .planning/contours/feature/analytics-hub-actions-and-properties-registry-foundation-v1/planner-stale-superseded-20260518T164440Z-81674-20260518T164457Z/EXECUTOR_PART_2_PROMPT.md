...
- Define boundary rules for Analytics Hub, Actions Registry inner page, Properties Registry foundation, Dashboard placeholder, and Export inside concrete registries only.
- Inspect source/runtime/docs for actual existing property sources.
- Classify property registry data as confirmed current source, hypothesis, or future backend/API requirement.
