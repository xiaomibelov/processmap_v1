...
## Input
- **role**: planner
- **contour**: feature/product-actions-output-v2
- **area/query**: product actions compact list tags taxonomy Excel CSV export / product actions output v2 compact table tags action_text object stage method Excel CSV export prompt registry
- **generated_at**: 2026-08-26T06:21:55.514Z
...
- ```bash
node tools/rag/pm-rag-search.mjs "product actions compact list tags taxonomy Excel CSV export" --top-k 5
```
- ```bash
node tools/rag/pm-rag-search-facts.mjs "product actions compact list tags taxonomy Excel CSV export" --top-k 8 --json
```
- ```bash
node tools/rag/pm-rag-agent-preflight.mjs --role planner --contour "feature/product-actions-output-v2" --area "product actions compact list tags taxonomy Excel CSV export" --format md
```
- ```bash
