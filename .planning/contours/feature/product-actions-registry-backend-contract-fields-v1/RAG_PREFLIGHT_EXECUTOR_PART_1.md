...
- **generated_at**: 2026-05-19T13:42:54.852Z
...
```
- ```bash
node tools/rag/pm-rag-agent-preflight.mjs --role executor --contour "feature/product-actions-registry-backend-contract-fields-v1" --area "executor part 1 context" --format md
```
- ```bash
