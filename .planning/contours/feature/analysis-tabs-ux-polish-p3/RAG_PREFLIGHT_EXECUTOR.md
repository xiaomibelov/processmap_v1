...
## Input
- **role**: executor
- **contour**: feature/analysis-tabs-ux-polish-p3
- **area/query**: process analysis UI i18n AI RAG / processAnalysis KPI i18n keys ProductActionSuggestionsPanel error states RAG status
- **generated_at**: 2026-08-25T21:32:57.341Z
...
- ```bash
node tools/rag/pm-rag-search.mjs "process analysis UI i18n AI RAG" --top-k 5
```
- ```bash
node tools/rag/pm-rag-search-facts.mjs "process analysis UI i18n AI RAG" --top-k 8 --json
```
- ```bash
node tools/rag/pm-rag-agent-preflight.mjs --role executor --contour "feature/analysis-tabs-ux-polish-p3" --area "process analysis UI i18n AI RAG" --format md
```
- ```bash
