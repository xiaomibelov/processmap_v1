...
- You must NOT wait for Worker 3.
- You must NOT require Worker 3 outputs.
- You must NOT read WORKER_3_REPORT.md or wait for WORKER_3_DONE.
- You must NOT validate Worker 3 work.
...
If you are blocked and cannot complete, create `EXEC_PART_1_BLOCKED.md` (NOT global `EXEC_BLOCKED.md`).
