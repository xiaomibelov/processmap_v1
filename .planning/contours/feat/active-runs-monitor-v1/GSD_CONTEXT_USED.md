...
- No specific GSD skill invoked for this contour (scope is small and self-contained).
- `gsd-fast` skill available for trivial inline tasks if executor needs it.
- Branch naming follows project convention: `feat/active-runs-monitor-v1`.
