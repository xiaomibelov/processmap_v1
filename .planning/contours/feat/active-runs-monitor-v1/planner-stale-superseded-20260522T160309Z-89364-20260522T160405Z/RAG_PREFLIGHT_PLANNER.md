...
- generated_at: `2026-05-22T16:03:48Z`
...
- **role**: planner
- **contour**: feat/active-runs-monitor-v1
- **area/query**: ProcessMap planning context feat/active-runs-monitor-v1
- **generated_at**: 2026-05-22T16:03:43.079Z
...
- **snippet**:
```
- **role**: planner - **contour**: *feat*/analytics-registries-viewmodel-ui-*v1* - **area/query**: *ProcessMap* *planning* *context* *feat*/analytics-registries-viewmodel-ui-*v1* - **generated_at**: 2026-05-21T22:35:26.630Z
```

### #2 — Input
- **score**: 27.263
- **path**: `/srv/obsidian/project-atlas/ProcessMap/AgentReports/uiux/registry-ui-spec-implementation-v1/RAG_PREFLIGHT_PLANNER.md`
- **source/category**: project-atlas / project_atlas
- **why_matched**: path_match, recent_14d, category_role
- **snippet**:
```
...
- ```bash
node tools/rag/pm-rag-search.mjs "ProcessMap planning context feat/active-runs-monitor-v1" --top-k 5
```
- ```bash
node tools/rag/pm-rag-search-facts.mjs "ProcessMap planning context feat/active-runs-monitor-v1" --top-k 8 --json
```
- ```bash
node tools/rag/pm-rag-agent-preflight.mjs --role planner --contour "feat/active-runs-monitor-v1" --area "ProcessMap planning context feat/active-runs-monitor-v1" --format md
```
- ```bash
