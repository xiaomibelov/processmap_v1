...
- generated_at: `2026-05-21T22:35:31Z`
- command: `node tools/rag/pm-rag-agent-preflight.mjs --role planner --contour "feat/analytics-registries-viewmodel-ui-v1" --area "ProcessMap planning context feat/analytics-registries-viewmodel-ui-v1" --format md --top-k 5`
...
- **role**: planner
- **contour**: feat/analytics-registries-viewmodel-ui-v1
- **area/query**: ProcessMap planning context feat/analytics-registries-viewmodel-ui-v1
- **generated_at**: 2026-05-21T22:35:26.630Z
...
### #1 — Input
- **score**: 59.217
- **path**: `/srv/obsidian/project-atlas/ProcessMap/AgentReports/feat/analytics-registries-viewmodel-ui-v1/RAG_PREFLIGHT_PLANNER.md`
- **source/category**: project-atlas / project_atlas
- **why_matched**: path_match, recent_14d, category_role
- **snippet**:
```
- **role**: planner - **contour**: *feat*/*analytics*-*registries*-*viewmodel*-*ui*-*v1* - **area/query**: *ProcessMap* *planning* *context* *feat*/*analytics*-*registries*-*viewmodel*-*ui*-*v1* - **generated_at**: 2026-05-21T22:28:07.369Z
```
...
- **snippet**:
```
- ```bash node tools/rag/pm-rag-search.mjs "*ProcessMap* *planning* *context* *feat*/*analytics*-*registries*-*viewmodel*-*ui*-*v1*" --top-k 5 ``` - ```bash node tools/rag/pm-rag-search-facts.mjs "*ProcessMap* *planning* *context* *feat*/*analytics*-*registries*-*viewmodel*-*ui*-*v1*" --top-k 8 --json ``` - ```bash node tools/rag/pm-rag-agent-preflight.mjs --role planner --contour "*feat*/*analytics*-*registries*-*viewmodel*-*ui*-*v1*" --area "*ProcessMap* *planning* *context* *feat*/*analytics*-*registries*-*viewmodel*-*ui*-*v1*" --format md ``` - ```bash node tools/rag/pm-rag-validate-facts.mjs ``` - ```bash node tools/rag/pm-rag-run-validation-queries.mjs
```
...
- **snippet**:
```
- run_id: `20260521T222731Z-49334` - contour: `*feat*/*analytics*-*registries*-*viewmodel*-*ui*-*v1*` - generated_by: `*processmap*-agent-pane.sh` - generated_at: `2026-05-21T22:28:12Z` - command: `node tools/rag/pm-rag-agent-preflight.mjs --role planner --contour "*feat*/*analytics*-*registries*-*viewmodel*-*ui*-*v1*" --area "*ProcessMap* *planning* *context* *feat*/*analytics*-*registries*-*viewmodel*-*ui*-*v1*" --format md --top-k 5`
```
...
- ```bash
node tools/rag/pm-rag-search.mjs "ProcessMap planning context feat/analytics-registries-viewmodel-ui-v1" --top-k 5
```
- ```bash
node tools/rag/pm-rag-search-facts.mjs "ProcessMap planning context feat/analytics-registries-viewmodel-ui-v1" --top-k 8 --json
```
- ```bash
node tools/rag/pm-rag-agent-preflight.mjs --role planner --contour "feat/analytics-registries-viewmodel-ui-v1" --area "ProcessMap planning context feat/analytics-registries-viewmodel-ui-v1" --format md
```
- ```bash
