...
- **generated_at**: 2026-05-18T11:20:39.584Z
...
```
- ```bash
node tools/rag/pm-rag-agent-preflight.mjs --role executor --contour "uiux/product-actions-registry-single-surface-visual-system-v1" --area "executor part 1 context" --format md
```
- ```bash
