...
## Input
- **role**: executor
- **contour**: audit/tobe-diff-keys-v1
- **area/query**: 
- **generated_at**: 2026-09-15T22:59:52.856Z
...
- ```bash
node tools/rag/pm-rag-search.mjs "audit/tobe-diff-keys-v1" --top-k 5
```
- ```bash
node tools/rag/pm-rag-search-facts.mjs "audit/tobe-diff-keys-v1" --top-k 8 --json
```
- ```bash
node tools/rag/pm-rag-agent-preflight.mjs --role executor --contour "audit/tobe-diff-keys-v1" --area "scope" --format md
```
- ```bash
