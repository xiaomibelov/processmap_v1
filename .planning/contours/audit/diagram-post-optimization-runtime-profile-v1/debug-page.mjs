...
const hasShapes = await page.locator('.djs-shape').count();
const text = await page.locator('body').innerText();

console.log('Title:', title);
console.log('hasReady:', hasReady);
console.log('hasCanvas:', hasCanvas);
console.log('hasShapes:', hasShapes);
console.log('Body text first 500 chars:', text.slice(0, 500));

await page.screenshot({ path: '/opt/processmap-test/.planning/contours/audit/diagram-post-optimization-runtime-profile-v1/evidence/screenshots/debug.png', fullPage: true });
await browser.close();
