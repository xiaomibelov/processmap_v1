...
- generated_at: `2026-05-21T10:12:21Z`
- command: `node tools/rag/pm-rag-agent-preflight.mjs --role planner --contour "release/processmap-v1-0-140-stage-promotion-and-analytics-entry-fix-v1" --area "ProcessMap planning context release/processmap-v1-0-140-stage-promotion-and-analytics-entry-fix-v1" --format md --top-k 5`
...
- **role**: planner
- **contour**: release/processmap-v1-0-140-stage-promotion-and-analytics-entry-fix-v1
- **area/query**: ProcessMap planning context release/processmap-v1-0-140-stage-promotion-and-analytics-entry-fix-v1
- **generated_at**: 2026-05-21T10:12:16.331Z
...
### #1 — 6. Context Sources
- **score**: 45.275
- **path**: `/opt/processmap-test/.planning/contours/release/processmap-consolidate-dirty-tree-fix-tests-and-stage-v1/PLAN.md`
- **source/category**: planning-contours / contour
- **why_matched**: exact_contour_id, path_match, heading_match, recent_14d, category_role
- **snippet**:
```
[contour: *processmap*-consolidate-dirty-tree-*fix*-tests-and-*stage*-*v1*] ## 6. *Context* Sources
- RAG preflight: `.*planning*/contours/*release*/*processmap*-consolidate-dirty-tree-*fix*-tests-and-*stage*-*v1*/RAG_PREFLIGHT_PLANNER.md` - Obsidian *context*: `.*planning*/contours/*release*/*processmap*-consolidate-dirty-tree-*fix*-tests-and-*stage*-*v1*/OBSIDIAN_*CONTEXT*_USED.md` - GSD *context*: `.*planning*/contours/*release*/*processmap*-consolidate-dirty-tree-*fix*-tests-and-*stage*-*v1*/GSD_*CONTEXT*_USED.md`
```

### #2 — 6. Context Sources
- **score**: 42.775
- **path**: `/srv/obsidian/project-atlas/ProcessMap/AgentReports/release/processmap-consolidate-dirty-tree-fix-tests-and-stage-v1/PLAN.md`
...
### #3 — Input
- **score**: 39.196
- **path**: `/opt/processmap-test/.planning/contours/release/processmap-consolidate-dirty-tree-fix-tests-and-stage-v1/RAG_PREFLIGHT_PLANNER.md`
- **source/category**: planning-contours / contour
- **why_matched**: exact_contour_id, path_match, recent_14d, category_role
- **snippet**:
```
[contour: *processmap*-consolidate-dirty-tree-*fix*-tests-and-*stage*-*v1*] - **role**: planner - **contour**: *release*/*processmap*-consolidate-dirty-tree-*fix*-tests-and-*stage*-*v1* - **area/query**: *ProcessMap* *planning* *context* *release*/*processmap*-consolidate-dirty-tree-*fix*-tests-and-*stage*-*v1* - **generated_at**: 2026-05-21T09:04:14.676Z
```
...
- **snippet**:
```
[contour: *processmap*-consolidate-dirty-tree-*fix*-tests-and-*stage*-*v1*] - ```bash node tools/rag/pm-rag-search.mjs "*ProcessMap* *planning* *context* *release*/*processmap*-consolidate-dirty-tree-*fix*-tests-and-*stage*-*v1*" --top-k 5 ``` - ```bash node tools/rag/pm-rag-search-facts.mjs "*ProcessMap* *planning* *context* *release*/*processmap*-consolidate-dirty-tree-*fix*-tests-and-*stage*-*v1*" --top-k 8 --json ``` - ```bash node tools/rag/pm-rag-agent-preflight.mjs --role planner --contour "*release*/*processmap*-consolidate-dirty-tree-*fix*-tests-and-*stage*-*v1*" --area "*ProcessMap* *planning* *context* *release*/*processmap*-consolidate-dirt…
```
...
- **snippet**:
```
[contour: *processmap*-consolidate-dirty-tree-*fix*-tests-and-*stage*-*v1*] ## Obsidian *Context* Used
- run_id: `20260521T090400Z-76203` - contour: `*release*/*processmap*-consolidate-dirty-tree-*fix*-tests-and-*stage*-*v1*` - generated_by: `*processmap*-agent-pane.sh` - generated_at: `2026-05-21T09:04:24Z` - obsidian_root: `/srv/obsidian/project-atlas/*ProcessMap*` - obsidian_root_exists: `yes` - obsidian_markdown_files_visible: `879` - query: `Obsidian Project Atlas *ProcessMap* *planning* *context* *release*/*processmap*-consolidate-dirty-tree-*fix*-tests-and-*stage*-*v1*`
```
...
- ```bash
node tools/rag/pm-rag-search.mjs "ProcessMap planning context release/processmap-v1-0-140-stage-promotion-and-analytics-entry-fix-v1" --top-k 5
```
- ```bash
node tools/rag/pm-rag-search-facts.mjs "ProcessMap planning context release/processmap-v1-0-140-stage-promotion-and-analytics-entry-fix-v1" --top-k 8 --json
```
- ```bash
node tools/rag/pm-rag-agent-preflight.mjs --role planner --contour "release/processmap-v1-0-140-stage-promotion-and-analytics-entry-fix-v1" --area "ProcessMap planning context release/processmap-v1-0-140-stage-promotion-and-analytics-entry-fix-v1" --format md
```
- ```bash
...
## Planner Decisions (Agent 1, 2026-05-21T10:12Z)
- Reused launcher RAG preflight; no narrower query needed.
- Contour mode: SINGLE_EXECUTOR_MODE (token economy).
- Key fact from RAG: previous contour `processmap-consolidate-dirty-tree-fix-tests-and-stage-v1` completed with clean tree and v1.0.140 bump.
- Analytics entry bug identified from codebase inspection: `WorkspaceExplorer.jsx` ignores `onOpenAnalyticsHub` prop.
