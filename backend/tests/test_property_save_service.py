...
class CamundaExtensionPropertyDedupTests(unittest.TestCase):
    ...
    def test_keep_last_property_by_name(self):
        src = {
            "Activity_1": {
                "properties": {
                    "extensionProperties": [
    ...
    def test_multiple_elements_preserved(self):
        ...
        result = _deduplicate_camunda_extension_properties(src)
        self.assertEqual(result["A"]["properties"]["extensionProperties"], [{"name": "x", "value": "2"}])
    ...
    def test_ignores_rows_without_name(self):
        ...
        result = _deduplicate_camunda_extension_properties(src)
        self.assertEqual(result["A"]["properties"]["extensionProperties"], [{"name": "ok", "value": "yes"}])
