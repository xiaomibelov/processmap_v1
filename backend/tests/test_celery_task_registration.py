...
class CeleryTaskRegistrationTest(unittest.TestCase):
    def setUp(self):
        ...
        os.environ["PROCESS_DB_PATH"] = str(Path(self.tmp.name) / "celery_tasks.sqlite3")
    ...
    def test_analytics_aggregator_task_is_registered(self):
        """Regression test for 'refresh_session_analytics_task unregistered'."""
