...
from .sessions_bpmn import (  # noqa: F401  # re-export facade (PR-12 sessions-bpmn)
    _FLOW_META_R_SOURCE_SET,
    _FLOW_TIERS,
    _NODE_PATH_CODE_SET,
    _NODE_PATH_CODES,
    _NODE_PATH_SOURCE_SET,
    _PATH_TIER_ALIASES,
    _R_FLOW_TIERS,
    _R_TIER_ALGO_VERSION,
    _USER_FACING_BPMN_VERSION_ACTIONS,
    _bpmn_version_row_is_user_facing,
    _build_bpmn_version_author,
    _create_bpmn_revision_snapshot_if_needed,
    _entry_to_flow_tier,
    _infer_and_merge_rtiers,
    _latest_user_facing_bpmn_version,
    _normalize_flow_meta_entry,
    _normalize_flow_meta_r_source,
    _normalize_flow_tier,
    _normalize_node_path_code,
    _normalize_node_path_entry,
    _normalize_node_path_source,
    _normalize_node_paths,
    _normalize_r_flow_tier,
    _overlay_interview_annotations_on_bpmn_xml,
    _plan_bpmn_revision_snapshot_if_needed,
    _to_epoch_iso,
    session_bpmn_clear,
    session_bpmn_export,
...
# /api/sessions/* handler implementations for BPMN live in app/sessions_bpmn.py
# (PR-12 sessions-bpmn) and are re-registered here so LEGACY_ROUTE_EXPORT
# keeps the same routes, methods, registration order and endpoint objects
# as before the extraction.
app.get("/api/sessions/{session_id}/bpmn_meta")(session_bpmn_meta_get)
app.patch("/api/sessions/{session_id}/bpmn_meta")(session_bpmn_meta_patch)
app.post("/api/sessions/{session_id}/bpmn_meta/infer_rtiers")(session_bpmn_meta_infer_rtiers)
app.get("/api/sessions/{session_id}/bpmn")(session_bpmn_export)
app.get("/api/sessions/{session_id}/overlays")(session_overlays)
app.put("/api/sessions/{session_id}/bpmn")(session_bpmn_save)
app.get("/api/sessions/{session_id}/bpmn/versions")(session_bpmn_versions_list)
app.get("/api/sessions/{session_id}/bpmn/versions/{version_id}")(session_bpmn_version_detail)
app.post("/api/sessions/{session_id}/bpmn/restore/{version_id}")(session_bpmn_restore)
app.delete("/api/sessions/{session_id}/bpmn")(session_bpmn_clear)
