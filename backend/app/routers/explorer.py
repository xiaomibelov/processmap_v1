...
def get_explorer_page(
    ...
    for f in children.get("folders", []):
        ...
        items.append({
            ...
            "descendant_done_sessions_count": folder_out.get("descendant_done_sessions_count", 0),
            "descendant_trackable_sessions_count": folder_out.get("descendant_trackable_sessions_count", 0),
